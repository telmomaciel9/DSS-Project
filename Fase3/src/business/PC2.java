...
public class PC2 extends Carro
{
    ...
    public PC2(int id, String marca, String modelo, int cilindrada, int potencia, Piloto p,int p_mecanica,String tipoPneu,String modoMotor)
    {
        super(id,marca,modelo,cilindrada,potencia,p,70,tipoPneu,modoMotor);
