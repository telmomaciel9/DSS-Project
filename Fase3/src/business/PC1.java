...
public class PC1 extends Carro
{
    ...
    public PC1(String marca, String modelo, int cilindrada, int potencia, Equipa e, String tipoPneu,String modoMotor)
    {
        super(marca,modelo,cilindrada,potencia,e,85,tipoPneu,modoMotor);
    }
